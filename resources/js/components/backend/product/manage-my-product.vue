            ...
            <div class="manage-product col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                        	<h4 class="text-primary text-left">My Products</h4>
                        ...
                        <table class="table table-responsive table-bordered">
                            ...
                            <tr v-if="SearchResults.length" v-for="product,index in SearchResults">
                                ...
                                <td>
                                    ...
                                    <router-link :to="`/edit-product-image/${product.slug}`" class="btn btn-dark btn-sm" title="Edit Product">Edit Product Image</router-link>
...
<script>
	export default{
		...
		methods:{
			getValue(){
				this.form.post('/get-search-my-product').then((response)=>{
			...
			getResults(page = 1) {
			axios.get('get-my-product?page=' + page)
				.then(response => {
