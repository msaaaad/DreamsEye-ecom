                ...
                <div class="add-category col-10 offset-1">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <h4 class="text-primary text-left">Add Product</h4>
                                <router-link to="/manage-product" class="ml-auto btn btn-outline-primary">Manage Product</router-link>
                            </div>
                        </div>
                        <div class="card-body">
...
<script>
    ...
    export default{
        ...
        computed:{
        	Categories(){
        		return this.$store.getters.categories;keyup
        	},
        },
        methods:{
            fieldChange(e){
