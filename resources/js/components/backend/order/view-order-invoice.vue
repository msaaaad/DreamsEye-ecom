                                ...
                                <div class="inv-header">
                                    ...
                                    <div>
                                        <table>
                                            ...
                                            <tr>
                                                <th>Date</th>
                                                <td>{{order.created_at|subString(10)}}</td>
                                            </tr>
                                            <tr>
                                                <th>Amount Due</th>
                                ...
                                <div class="inv-footer">
                                    ...
                                    <div>
                                        <table>
                                            ...
                                            <tr>
                                                <th>Grand total</th>
                                                <td>{{sum+order.shipping_total}}</td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
...
<script>
	export default{
		...
		methods:{
			getInvoice(){
				axios.get('/get-invoice/'+this.$route.params.id).then((response)=>{
