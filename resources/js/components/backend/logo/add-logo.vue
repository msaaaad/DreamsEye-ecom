        ...
        <div class="container">
            <div class="row">
                <div class="add-category col-10 offset-1">
                    <div class="card">
                        <h5 class="card-header text-success text-center">Add Logo Image</h5>
                                                <div class="card-body">
                            <form @submit.prevent="addLogo" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <img :src="form.logo_image" height="70px" width="85px" alt="">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-8 offset-4">
                                        ...
                                        <input type="submit" value="Save Logo Image" class="form-control btn btn-info text-white">
                                    </div>
                                </div>
...
<script>
    export default{
        ...
        methods:{
            addLogo:function(){
                let test = this;
                this.form.post('/save-logo').then(function(data){
                       /*
                         Toast.fire({
                            icon: 'success',
